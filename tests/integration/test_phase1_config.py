...
class TestConfigurationSystemIntegration(BaseIntegrationTest):
    ...
    def setUp(self):
        ...
        self.encrypted_config_path = os.path.join(self.test_data_dir, "encrypted_settings.yaml")
    ...
    def test_encrypted_config_loading(self):
        ...
        with patch.dict(os.environ, {"NGINX_MONITOR_KEY": "test_encryption_key"}):
            loaded_config = self.components['config_manager'].load_config(self.encrypted_config_path)
        
        # Assert: The loaded configuration should match the original
        self.assertIsNotNone(loaded_config)
        self.assertEqual(loaded_config['service']['check_interval'], 
    ...
    def test_config_validation_with_schema(self):
        ...
        invalid_config['pattern_detection']['thresholds']['requests_per_ip_per_minute'] = "not_a_number"
    ...
    def test_config_hot_reload_integration(self):
        ...
        updated_config['pattern_detection']['thresholds']['requests_per_ip_per_minute'] = 75
        ...
        self.assertEqual(pattern_detector.get_threshold('requests_per_ip_per_minute'), 75)
    ...
    def test_environment_override_integration(self):
        ...
        self.assertEqual(loaded_config['pattern_detection']['thresholds']['requests_per_ip_per_minute'], 120)
...
class TestConfigurationDataFlow(BaseIntegrationTest):
    ...
    def test_config_propagation_to_components(self):
        ...
        propagation_config['pattern_detection']['thresholds']['requests_per_ip_per_minute'] = 200
        ...
        self.assertEqual(pattern_detector.get_threshold('requests_per_ip_per_minute'), 200)
