...
class TestPluginSystemIntegration(BaseIntegrationTest):
    ...
    def setUp(self):
        ...
        self.custom_threat_plugin_path = os.path.join(
            self.plugins_dir, "custom_threat_detector.py"
        )
...
"""
    ...
    def test_plugin_alert_channel_integration(self):
        ...
        test_alert = {
            ...
            "details": {"source_ip": "192.168.1.50", "path": "/admin/backdoor"},
        }
